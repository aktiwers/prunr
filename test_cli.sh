...
# Prunr CLI test script
# Tests all CLI usage patterns against real images

BGPRUNR="cargo run -p prunr-app --features dev-models --"
...
bold "Test 3: prunr photo.jpg (shorthand, default output)"
...
bold "Test 4: prunr photo.jpg -o result.png"
...
bold "Test 5: prunr -m u2net photo.jpg"
...
bold "Test 6: prunr *.jpg -o output/ (batch to folder)"
...
bold "Test 7: prunr -j 2 *.jpg -o output/ (parallel)"
