...
pub(crate) fn render(ctx: &egui::Context, toasts: &mut crate::gui::toasts::Toasts) -> bool {
    theme::standard_modal_window(
        ...
        |ui| {
            ...
            ui.horizontal(|ui| {
                for (i, label) in ["Quick Start", "Lines", "Mask", "Eraser", "Advanced"]
                    .iter()
                    .enumerate()
                {
                    let selected = tab == i;
            ...
            match tab {
                ...
                1 => {
                    ...
                    egui::Grid::new("cli_lines_grid")
                        ...
                        .show(ui, |ui| {
                            ...
                            opt_row(
                                ui,
                                "--lines-after-bg",
                                "Remove BG first, then extract lines",
                            );
                            opt_row(
                                ui,
                                "--line-strength <n>",
                                "Detail level, 0.0\u{2013}1.0 (default 0.5)",
                            );
                            opt_row(
                                ui,
                                "--line-color <hex>",
                                "Solid color for lines (e.g. 000000)",
                            );
                            opt_row(
                                ui,
                                "--line-scale <scale>",
                                "Output scale: fine / balanced / bold / fused (default)",
                            );
                            opt_row(
                                ui,
                                "--bg-color <hex>",
                                "Fill background with color (e.g. ffffff)",
                            );
                        });
                    ...
                    example_row(
                        ui,
                        toasts,
                        "prunr --lines --line-strength 0.8 photo.jpg",
                        "Fine detail lines (more edges)",
                    );
                    example_row(
                        ui,
                        toasts,
                        "prunr --lines --line-color 333333 --bg-color eeeeee sketch.jpg",
                        "Dark gray lines on light gray background",
                    );
                    example_row(
                        ui,
                        toasts,
                        "prunr --lines --line-scale bold sketch.jpg",
                ...
                2 => {
                    ...
                    hint(
                        ui,
                        "Fine-tune how the background removal mask is generated.",
                    );
                    ...
                    egui::Grid::new("cli_mask_grid")
                        ...
                        .show(ui, |ui| {
                            ...
                            opt_row(ui, "--refine-edges", "Guided filter for fine edge detail");
                        });
                    ...
                    example_row(
                        ui,
                        toasts,
                        "prunr --refine-edges photo.jpg",
                        "Sharpen mask around hair and leaves",
                    );
                    example_row(
                        ui,
                        toasts,
                        "prunr --edge-shift 3 product.jpg",
                ...
                3 => {
                    ...
                    hint(
                        ui,
                        "Pass a binary mask (white = remove here, black = keep).",
                    );
                    ...
                    egui::Grid::new("cli_eraser_grid")
                        ...
                        .show(ui, |ui| {
                            ...
                            opt_row(
                                ui,
                                "--mask <path>",
                                "Binary mask, must match input dimensions",
                            );
                        });
                    ...
                    example_row(
                        ui,
                        toasts,
                        "prunr --inpaint photo.jpg --mask mask.png",
                        "Erase region defined by mask.png, save photo_erased.png",
                    );
                    example_row(
                        ui,
                        toasts,
                        "prunr --inpaint photo.jpg --mask mask.png -o clean.png",
                        "Custom output path",
                    );
                }
                ...
                4 => {
                    ...
                    egui::Grid::new("cli_models_grid")
                        ...
                        .show(ui, |ui| {
                            opt_row(
                                ui,
                                "birefnet-lite",
                                "Best detail, ~214 MB, 1024\u{00d7}1024 (default)",
                            );
                    ...
                    example_row(
                        ui,
                        toasts,
                        "prunr -m birefnet-lite portrait.jpg",
                    ...
                    example_row(
                        ui,
                        toasts,
                        "prunr --debug photo.jpg 2> prunr.log",
